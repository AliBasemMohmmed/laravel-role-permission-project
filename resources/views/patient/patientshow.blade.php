...
@section('content')
    ...
    <head>
        ...
        -------------------------------------------------- */
                ...
                of carousel content */ .carousel-caption p {
                    margin-bottom: 1.25rem;
                    font-size: 1.25rem;
                    line-height: 1.4;
                }
            ...
            <div id="myCarousel" class="carousel slide mb-6" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="bd-placeholder-img" width="100%" height="100%" src="icon/aaa.jpg"
            ...
            <div class="container marketing">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        ...
                        src="icon/aaa.jpg" role="img" aria-label="Placeholder"
                ...
                <div class="row featurette">
                    ...
                    <div class="col-md-5">
                        <img class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto"
                            width="500" height="500" src="icon/aaa.jpg" role="img"
